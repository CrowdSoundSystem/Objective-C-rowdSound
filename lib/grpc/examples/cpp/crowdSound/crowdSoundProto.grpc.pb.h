...
// source: crowdSoundProto.proto
#ifndef GRPC_crowdSoundProto_2eproto__INCLUDED
#define GRPC_crowdSoundProto_2eproto__INCLUDED

#include "crowdSoundProto.pb.h"
 ...
 public:
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status ListTrendingArtists(::grpc::ClientContext* context, const ::CrowdSound::ListTrendingArtistsRequest& request, ::CrowdSound::ListTrendingArtistsResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::CrowdSound::ListTrendingArtistsResponse>> AsyncListTrendingArtists(::grpc::ClientContext* context, const ::CrowdSound::ListTrendingArtistsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::CrowdSound::ListTrendingArtistsResponse>>(AsyncListTrendingArtistsRaw(context, request, cq));
    }
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::CrowdSound::ListTrendingArtistsResponse>* AsyncListTrendingArtistsRaw(::grpc::ClientContext* context, const ::CrowdSound::ListTrendingArtistsRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub GRPC_FINAL : public StubInterface {
   public:
    ...
    ::grpc::Status ListTrendingArtists(::grpc::ClientContext* context, const ::CrowdSound::ListTrendingArtistsRequest& request, ::CrowdSound::ListTrendingArtistsResponse* response) GRPC_OVERRIDE;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::CrowdSound::ListTrendingArtistsResponse>> AsyncListTrendingArtists(::grpc::ClientContext* context, const ::CrowdSound::ListTrendingArtistsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::CrowdSound::ListTrendingArtistsResponse>>(AsyncListTrendingArtistsRaw(context, request, cq));
    }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::CrowdSound::ListTrendingArtistsResponse>* AsyncListTrendingArtistsRaw(::grpc::ClientContext* context, const ::CrowdSound::ListTrendingArtistsRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
  ...
  class Service : public ::grpc::SynchronousService {
   public:
    ...
    virtual ::grpc::Status ListTrendingArtists(::grpc::ServerContext* context, const ::CrowdSound::ListTrendingArtistsRequest* request, ::CrowdSound::ListTrendingArtistsResponse* response);
  ...
  class AsyncService GRPC_FINAL : public ::grpc::AsynchronousService {
   public:
    ...
    void RequestListTrendingArtists(::grpc::ServerContext* context, ::CrowdSound::ListTrendingArtistsRequest* request, ::grpc::ServerAsyncResponseWriter< ::CrowdSound::ListTrendingArtistsResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag);
...
#endif  // GRPC_crowdSoundProto_2eproto__INCLUDED
