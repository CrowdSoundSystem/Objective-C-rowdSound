...
CrowdSound::Stub::Stub(const std::shared_ptr< ::grpc::Channel>& channel)
  ...
  , rpcmethod_ListTrendingArtists_(CrowdSound_method_names[1], ::grpc::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status CrowdSound::Stub::ListTrendingArtists(::grpc::ClientContext* context, const ::CrowdSound::ListTrendingArtistsRequest& request, ::CrowdSound::ListTrendingArtistsResponse* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_ListTrendingArtists_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::CrowdSound::ListTrendingArtistsResponse>* CrowdSound::Stub::AsyncListTrendingArtistsRaw(::grpc::ClientContext* context, const ::CrowdSound::ListTrendingArtistsRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::CrowdSound::ListTrendingArtistsResponse>(channel_.get(), cq, rpcmethod_ListTrendingArtists_, context, request);
}
...
::grpc::Status CrowdSound::Service::ListTrendingArtists(::grpc::ServerContext* context, const ::CrowdSound::ListTrendingArtistsRequest* request, ::CrowdSound::ListTrendingArtistsResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
void CrowdSound::AsyncService::RequestListTrendingArtists(::grpc::ServerContext* context, ::CrowdSound::ListTrendingArtistsRequest* request, ::grpc::ServerAsyncResponseWriter< ::CrowdSound::ListTrendingArtistsResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
...
::grpc::RpcService* CrowdSound::Service::service() {
  ...
  service_->AddMethod(new ::grpc::RpcServiceMethod(
      ...
      new ::grpc::RpcMethodHandler< CrowdSound::Service, ::CrowdSound::ListTrendingArtistsRequest, ::CrowdSound::ListTrendingArtistsResponse>(
