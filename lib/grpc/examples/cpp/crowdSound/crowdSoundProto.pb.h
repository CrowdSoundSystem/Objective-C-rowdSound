...
#ifndef PROTOBUF_crowdSoundProto_2eproto__INCLUDED
#define PROTOBUF_crowdSoundProto_2eproto__INCLUDED
...
class ListSongsRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_crowdSoundProto_2eproto();
  friend void protobuf_AssignDesc_crowdSoundProto_2eproto();
  friend void protobuf_ShutdownFile_crowdSoundProto_2eproto();
...
// optional bool dislike = 4;
inline void VoteSongRequest::clear_dislike() {
  dislike_ = false;
}
inline bool VoteSongRequest::dislike() const {
  // @@protoc_insertion_point(field_get:CrowdSound.VoteSongRequest.dislike)
  return dislike_;
}
inline void VoteSongRequest::set_dislike(bool value) {
...
#endif  // PROTOBUF_crowdSoundProto_2eproto__INCLUDED
