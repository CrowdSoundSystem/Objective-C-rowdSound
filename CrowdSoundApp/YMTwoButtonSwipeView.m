...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIImage *likeView = [UIImage imageNamed:@"Thumb Up-50"];
        UIImage *dislikeView = [UIImage imageNamed:@"Thumbs Down-50"];
        ...
        [leftButton setImage:likeView forState:UIControlStateNormal];
        ...
        [rightButton setImage:dislikeView forState:UIControlStateNormal];
